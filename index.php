...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Adopt Pets</h1>
                            <p class="intro-text">
                                Your little friend is waiting for you.. 
                                Share some love and care to the needy ones!
                            </p>
    ...
    <div id="sec2" style="color: #777;background-color:white;text-align:center;padding:50px 80px;text-align: justify;">
        <h3 style="text-align:center;">Available Pets</h3>
<br>
        <section class="menu-content">
            <?php   
            $sql1 = "SELECT * FROM pets WHERE pet_availability='yes'";
            ...
            if(mysqli_num_rows($result1) > 0) {
                while($row1 = mysqli_fetch_assoc($result1)){
                    ...
                    $pet_img = $row1["pet_img"];
               
                    ?>
            <a href="booking.php?id=<?php echo($pet_id) ?>">
            <div class="sub-menu">
            

            <img class="card-img-top" src="<?php echo $pet_img; ?>" alt="Card image cap">
            <h5><b> <?php echo $pet_name." ".  " : ". $pet_breed." ". "Age: ". $pet_age;  ?></b></h5>
            <h6> With Food Charge: <?php echo ("Rs. " . $with_food_price . " Rs." . $with_food_per_day . "/day"); ?></h6>
            <h6> Without Food Charge: <?php echo ("Rs. " . $without_food_price ); ?></h6><br>
...
<h1> No pets available :( </h1>
    ...
    <footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> Adopt Pets</h5>
                </div>
