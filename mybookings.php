...
<?php $login_customer = $_SESSION['login_customer']; 
    ...
    $sql1 = "SELECT * FROM adoptedpets rc, pets c
    WHERE rc.customer_username='$login_customer' AND c.pet_id=rc.pet_id ";
...
<tr>
<th width="15%">Pet</th>
<th width="15%">BookingDate</th>
<th width="15%">Adopt Date</th>
...
<?php        } ?>
        ...
        <div class="container">
      <div class="jumbotron">
        <h1 class="text-center">You have not adopted any Pets till now!</h1>
        <p class="text-center"> Please rent pets in order to view your data here. </p>
      </div>
    </div>
...
<footer class="site-footer">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h5>© <?php echo date("Y"); ?> pet Rentals</h5>
                </div>
            </div>
        </div>
    </footer>
