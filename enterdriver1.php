...
$owner_gender = $conn->real_escape_string($_POST['owner_gender']);
$client_username = $_SESSION['login_client'];
$owner_availability = "yes";

$query = "INSERT into owner(owner_name,dl_number,owner_phone,owner_address,owner_gender,client_username,owner_availability) VALUES('" . $owner_name . "','" . $dl_number . "','" . $owner_phone . "','" . $owner_address . "','" . $owner_gender ."','" . $client_username ."','" . $owner_availability ."')";
